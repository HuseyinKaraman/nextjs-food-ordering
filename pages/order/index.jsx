            ...
            <div className="flex w-full justify-between flex-col md:min-h-[calc(100vh_-_488px)] mt-8">
                ...
                <div className="flex justify-between items-center gap-4 mx-5 md:mx-10 mb-10 mt-10 p-5 bg-primary text-xs md:text-base">
                    <div className="relative">
                        <Image alt="" src={"/images/paid.png"} width={80} height={80} className="w-10 h-10 md:!w-20 md:!h-20" objectFit="contain"/>
                        <span>Payment</span>
                    </div>
                    <div className="relative animate-bounce">
                        <Image alt="" src={"/images/bake.png"} width={80} height={80} className="w-10 h-10 md:!w-20 md:!h-20"  objectFit="contain"/>
                        <span>Preparing</span>
                    </div>
                    <div className="relative">
                        <Image alt="" src={"/images/bike.png"} width={80} height={80} className="w-10 h-10 md:!w-20 md:!h-20"  objectFit="contain"/>
                        <span>On The Way</span>
                    </div>
                    <div className="relative">
                        <Image alt="" src={"/images/delivered.png"} width={80} height={80} className="w-10 h-10 md:!w-20 md:!h-20"  objectFit="contain"/>
                        <span>Delivered</span>
                    </div>
                </div>
            </div>
