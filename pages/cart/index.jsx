    ...
    return (
        <div className="flex w-full flex-col justify-evenly md:h-[calc(100vh_-_88px)] my-10 md:my-0 px-0 md:px-10 gap-y-10">
            {cart.products.length > 0 ? (
                        ...
                        <table className="w-full text-center text-gray-500">
                            ...
                            <tbody>
                                {cart.products.map((item) => (
                                    <tr
                                        className="bg-secondray border-gray-700 hover:bg-primary transition-all"
                                        key={item.id}
                                    >
                                        ...
                                        <td className="py-4 px-6 font-medium hover:text-white">
                                            {item.extras.length>0 ? item.extras.map((extra) => extra.text + ", ") : "Empty"}
                                        </td>
                ...
                <p className="text-center font-semibold">No product in cart...</p>
            )}
        </div>
    );
};
